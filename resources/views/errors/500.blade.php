    ...
    <div class="md:flex min-h-screen">
        <div class="w-full md:w-1/2 bg-white flex items-center justify-center">
            <div class="max-w-md m-8">
                ...
                <x-outlined-button href="{{ url('/') }}" class="text-green-500 text-base font-bold py-3 px-6 border-2 border-green-500 hover:bg-green-400 hover:border-green-400 focus:border-green-600 focus:ring-green active:bg-green-600">
                    {{ __('Go Home') }}
                </x-outlined-button>
            </div>
        </div>
