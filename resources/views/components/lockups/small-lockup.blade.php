...
{{--                        <p class="text-xs leading-tight text-black/60 whitespace-nowrap">{{ $anime->mediaStatus->name }}</p>--}}
                    ...
                    <div class="space-y-1">
                        <p class="text-xs leading-tight text-black/60 line-clamp-2">{{ empty($anime->tagline) ? ($anime->geres?->pluck('name')->join(', ', ' and ') ?? $anime->themes?->pluck('name')->join(', ', ' and ')) : $anime->tagline }}</p>
...
{{--                        <p class="text-xs leading-tight text-black/60 whitespace-nowrap">{{ $game->mediaStatus->name }}</p>--}}
                    ...
                    <div class="space-y-1">
                        <p class="text-xs leading-tight text-black/60 line-clamp-1">{{ empty($game->tagline) ? ($game->geres?->pluck('name')->join(', ', ' and ') ?? $game->themes?->pluck('name')->join(', ', ' and ')) : $game->tagline }}</p>
...
{{--                        <p class="text-xs leading-tight text-black/60 whitespace-nowrap">{{ $manga->mediaStatus->name }}</p>--}}
                    ...
                    <div class="space-y-1">
                        <p class="text-xs leading-tight text-black/60 line-clamp-2">{{ empty($manga->tagline) ? ($manga->geres?->pluck('name')->join(', ', ' and ') ?? $manga->themes?->pluck('name')->join(', ', ' and ')) : $manga->tagline }}</p>
