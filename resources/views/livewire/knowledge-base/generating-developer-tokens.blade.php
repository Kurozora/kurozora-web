<main>
    ...
    <div class="pt-4 pb-6 max-w-full prose prose-theme lg:prose-lg">
        <x-picture class="mb-8 ml-4 mr-4 not-prose">
            <img class="h-32 w-full object-cover object-center rounded-lg shadow-lg sm:h-60" src="{{ asset('images/static/banners/generate_developer_tokens.webp') }}"  alt="Generate Developer Tokens" />
        </x-picture>
        ...
        {{-- Overview --}}
        <section id="overview" class="xl:safe-area-inset">
            <div class="pr-4 pl-4">
        ...
        <section id="create-a-developer-token" class="xl:safe-area-inset">
            <div class="pr-4 pl-4">
                <h2 class="text-xl font-bold">
        ...
        {{-- Authorize Requests --}}
        <section id="authorize-requests" class="xl:safe-area-inset">
            <div class="pr-4 pl-4">
                <h2 class="text-xl font-bold">
        ...
        <section id="request-rate-limiting" class="xl:safe-area-inset">
            <div class="pr-4 pl-4">
                <h2 class="text-xl font-bold">
