            ...
            <div class="relative pb-2">
                <div class="flex flex-col flex-wrap text-center items-center">
                    <picture
                        ...
                        style="height: 128px; background-color: {{ $person->getFirstMedia(\App\Enums\MediaCollection::Profile)?->custom_properties['background_color'] ?? '#000000' }};"
                    >
        ...
        <section id="ratingsAndReviews" class="pt-5 pb-8 pl-4 pr-4 border-t-2">
            ...
            <div class="flex flex-row flex-wrap justify-between gap-4">
                ...
                <div class="flex flex-col justify-end items-center text-center">
                    ...
                    <p class="text-sm text-gray-500">{{ $person->mediaStat->sentiment }}</p>
                </div>

                <div class="flex flex-col w-full justify-end text-right sm:w-auto">
                    <x-star-rating-bar :media-stat="$person->mediaStat" />

                    <p class="text-sm text-gray-500">{{ trans_choice('[0,1] Not enough ratings|[2,*] :x Ratings', $person->mediaStat->rating_count, ['x' => number_format($person->mediaStat->rating_count)]) }}</p>
                </div>
            </div>
        </section>
