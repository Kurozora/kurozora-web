<main>
    ...
    <x-slot name="meta">
        ...
        <meta property="og:description" content="{{ __('Discover an extensive list of people, voice actors, cast, and staff on Kurozora, the largest, free online anime and manga database in the world.') }}" />
