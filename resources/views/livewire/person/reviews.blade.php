<main>
    ...
    <div class="pb-6" wire:init="loadPage">
        <x-back-link
            ...
            :title="__(':x’s Ratings & Reviews', ['x' => $person->full_name])"
        />
        ...
        <section id="writeAReview" class="pb-8">
            ...
            <div class="flex flex-row flex-wrap gap-4 pl-4 pr-4 xl:safe-area-inset-scroll">
                <div class="flex justify-between items-center">
                    ...
                    <livewire:components.rating-input :model-id="$person->id" :model-type="$person->getMorphClass()"  :rating="$this->userRating?->rating" :star-size="'md'" :review-box-id="$reviewBoxID" />
                </div>
