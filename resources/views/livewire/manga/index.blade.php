    ...
    <div class="pt-4 pb-6" wire:init="loadPage">
        ...
        @else
            <section class="flex flex-col items-center mt-4 text-center">
                <x-picture>
                    <img class="w-full max-w-sm" src="{{ asset('images/static/placeholders/empty_manga_library.webp') }}" alt="Empty Manga Index" title="Empty Manga Index">
                </x-picture>

                <p class="font-bold">{{ __('Manga Not Found') }}</p>

                <p class="text-sm text-secondary">{{ __('No manga found with the selected criteria.') }}</p>
            </section>
        @endif
    </div>
</main>
