<main>
    ...
    <x-slot:description>
        {{ __('An extensive list of manga, manhua, manhwa, and light novel adaptations to :x only on Kurozora, the largest, free online anime, manga, music & game database in the world.', ['x' => $manga->title]) }}
    </x-slot:description>
            ...
            <div>
                <div class="flex gap-1">
                    <div class="flex flex-wrap items-center w-full">
                        <p class="text-2xl font-bold">{{ __(':x’s Adaptations', ['x' => $manga->title]) }}</p>
                    </div>
