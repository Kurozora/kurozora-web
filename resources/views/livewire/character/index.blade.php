<main>
    ...
    <x-slot:description>
        {{ __('Discover the extensive list of characters only on Kurozora, the largest, free online anime, manga, music & game database in the world.') }}
    </x-slot:description>

    <x-slot:meta>
        <meta property="og:title" content="{{ __('Characters') }} — {{ config('app.name') }}" />
        <meta property="og:description" content="{{ __('Discover the extensive list of characters only on Kurozora, the largest, free online anime, manga, music & game database in the world.') }}" />
