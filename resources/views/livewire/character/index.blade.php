<main>
    ...
    <x-slot name="meta">
        ...
        <meta property="og:description" content="{{ __('Discover the extensive list of anime characters only on Kurozora, the largest, free online anime and manga database in the world.') }}" />
