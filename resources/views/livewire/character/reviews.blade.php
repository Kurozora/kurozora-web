            ...
            <div>
                <div class="flex gap-1 pl-4 pr-4">
                    <div class="flex flex-wrap items-center w-full">
                        <h1 class="text-2xl font-bold">{{ __(':x’s Ratings & Reviews', ['x' => $character->name]) }}</h1>
                    </div>
        ...
        <section id="writeAReview" class="mb-5 pt-4 border-t border-primary">
            <div class="flex flex-row flex-wrap gap-4 pl-4 pr-4">
                <div class="flex justify-between items-center">
                    ...
                    <livewire:components.star-rating :model-id="$character->id" :model-type="$character->getMorphClass()"  :rating="$this->userRating?->rating" :star-size="'md'" />
                </div>
