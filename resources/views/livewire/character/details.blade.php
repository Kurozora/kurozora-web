    ...
    <div class="max-w-7xl mx-auto pl-4 pr-4 py-6 sm:px-6" wire:init="loadPage">
        ...
        <section id="ratingsAndReviews" class="pt-5 pb-8 pl-4 pr-4 border-t-2">
            <x-section-nav>
                ...
                <x-slot:action>
                    <x-section-nav-link class="whitespace-nowrap" href="{{ route('characters.reviews', $character) }}">{{ __('See All') }}</x-section-nav-link>
                </x-slot:action>
            </x-section-nav>
        ...
        <section id="writeAReview" class="pt-5 pb-8 pl-4 pr-4 border-t-2">
            <div class="flex flex-row flex-wrap gap-4">
                <div class="flex justify-between items-center">
                    ...
                    <livewire:components.star-rating :model="$character" :rating="$userRating->first()?->rating" :star-size="'md'" />
                </div>
