<main>
    ...
    <x-slot name="meta">
        ...
        <meta property="og:description" content="{{ __('An extensive list of anime studios, producers, and networks only on Kurozora, the largest, free online anime and manga database in the world.') }}" />
