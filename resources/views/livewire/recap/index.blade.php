                        ...
                        @switch($recap->type)
                            @case(\App\Models\Anime::class)
                                <x-lockups.milestone-lockup
                                    ...
                                    :recap="null"
                                    :title="__('Your were in the top :x% of anime watchers this year.', ['x' => round($recap->top_percentile / 0.05) * 0.05])"
                            ...
                            @case(\App\Models\Manga::class)
                                <x-lockups.milestone-lockup
                                    ...
                                    style="min-width: 100%; max-width: 100%;"
                                    :recap="null"
                                    :title="__('Your were in the top :x% of manga readers this year.', ['x' => round($recap->top_percentile / 0.05) * 0.05])"
                            ...
                            @case(\App\Models\Games::class)
                                <x-lockups.milestone-lockup
                                    style="min-width: 100%; max-width: 100%;"
                                    :recap="null"
                                    :title="__('Your were in the top :x% of game players this year.', ['x' => round($recap->top_percentile / 0.05) * 0.05])"
