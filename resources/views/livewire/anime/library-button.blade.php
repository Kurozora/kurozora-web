...
>
    <x-select-button class="w-auto bg-orange-500 text-white font-semibold border-0 rounded-full shadow-md hover:bg-orange-400 active:bg-orange-600 focus:ring-0" x-model="libraryStatus" wire:model="libraryStatus" wire:change="updateLibraryStatus">
