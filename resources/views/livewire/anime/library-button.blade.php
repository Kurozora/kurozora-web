...
>
    <x-select-button chevronClass="w-4 h-4 text-white sm:w-6 sm:h-6" class="w-24 pl-1.5 pr-5 py-1 bg-orange-500 text-xs text-white font-semibold border-0 rounded-full shadow-md hover:bg-orange-400 active:bg-orange-600 focus:ring-0 sm:w-32 sm:pl-3 sm:pr-7 sm:py-2 sm:text-base" x-model="libraryStatus" wire:model="libraryStatus" wire:change="updateLibraryStatus">
