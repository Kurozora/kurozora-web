@php
    $classes = $isReminded
               ...
               : 'drop-shadow inline-flex justify-center items-center pl-4 pr-4 pt-2 pb-2 bg-tint btn-text-tinted font-semibold text-xs uppercase tracking-widest border-0 rounded-full shadow-md hover:bg-tint-800 active:bg-tint focus:ring-0 disabled:backdrop-filter disabled:bg-white/80 disabled:backdrop-blur disabled:text-gray-400 disabled:cursor-default';
@endphp
