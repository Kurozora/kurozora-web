<main>
    ...
    <x-slot:description>
        {{ __('Browse the archive of anime seasons. Join the Kurozora community and create your anime, manga and game list. Discover songs, episodes and read reviews and news!') }}
    </x-slot:description>

    <x-slot:meta>
        <meta property="og:title" content="{{ __('Seasonal Archive') }} | {{ __('Anime') }} — {{ config('app.name') }}" />
        <meta property="og:description" content="{{ __('Browse the archive of anime seasons. Join the Kurozora community and create your anime, manga and game list. Discover songs, episodes and read reviews and news!') }}" />
    ...
    <div class="max-w-7xl mx-auto pl-4 pr-4 py-6 sm:px-6">
        <p class="text-2xl font-bold">{{ __('Seasonal Anime Archive') }}</p>
