<main>
    ...
    <x-slot:description>
        {{ __('Browse the :x :y manga season. Join the Kurozora community and create your anime, manga and game list. Discover songs, episodes and read reviews and news!', ['x' => $this->seasonOfYear->key, 'y' => $year]) }}
    </x-slot:description>

    <x-slot:meta>
        <meta property="og:title" content="{{ $this->seasonOfYear->key . ' ' . $year }} | {{ __('Manga') }} — {{ config('app.name') }}" />
        <meta property="og:description" content="{{ __('Browse the :x :y manga season. Join the Kurozora community and create your anime, manga and game list. Discover songs, episodes and read reviews and news!', ['x' => $this->seasonOfYear->key, 'y' => $year]) }}" />
