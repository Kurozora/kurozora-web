<main>
    ...
    <x-slot name="description">
        {{ __('Discover the extensive list of themes only on Kurozora, the largest, free online anime and manga database in the world.') }}
    </x-slot>

    <x-slot name="meta">
        <meta property="og:title" content="{{ __('Themes') }} — {{ config('app.name') }}" />
        <meta property="og:description" content="{{ __('Discover the extensive list of themes only on Kurozora, the largest, free online anime and manga database in the world.') }}" />
        ...
        <section class="mb-4">
            <div>
                <div class="flex gap-1">
                    <p class="text-2xl font-bold">{{ __('Themes') }}</p>
