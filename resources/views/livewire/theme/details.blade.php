...
<main>
    ...
    <x-slot:description>
        {{ __('Discover the extensive list of :x anime only on Kurozora, the largest, free online anime, manga, music & game database in the world.', ['x' => $theme->name]) }} {{ $theme->description }}
    </x-slot:description>

    <x-slot:meta>
        <meta property="og:title" content="{{ $theme->name }} — {{ config('app.name') }}" />
        <meta property="og:description" content="{{ __('Discover the extensive list of :x anime only on Kurozora, the largest, free online anime, manga, music & game database in the world.', ['x' => $theme->name]) }} {{ $theme->description }}" />
