...
@section('content')
    ...
    <a href="{{ $confirmation_url }}" target="_blank" style="margin-top: 10px; display: block; border-radius: 10px; text-decoration: none; background: #ffa726; color: #fff; font-family: Ubuntu, Helvetica, Arial, sans-serif; font-size: 15px; font-weight: normal; padding: 5px 10px; text-align: center;">Confirm email address</a>
