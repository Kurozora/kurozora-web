                ...
                <div>
                    <span class="relative z-0 inline-flex rounded-md shadow-sm">
                        <span>
                            {{-- Previous Page Link --}}
                            @if ($paginator->onFirstPage())
                                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}" disabled>
                                    <span class="relative inline-flex items-center pl-2 pr-2 pt-2 pb-2 text-sm font-medium text-primary bg-primary border border-primary cursor-default rounded-l-md leading-5" aria-hidden="true">
                        ...
                        @foreach ($elements as $element)
                            ...
                            @if (is_string($element))
                                <span aria-disabled="true">
                                    <span class="relative inline-flex items-center pl-4 pr-4 pt-2 pb-2 -ml-px text-sm font-medium text-primary bg-primary border border-primary cursor-default leading-5 select-none">{{ $element }}</span>
                                </span>
                            @endif
                        ...
                        <span>
                            ...
                            @else
                                <span aria-disabled="true" aria-label="{{ __('pagination.next') }}" disabled>
                                    <span class="relative inline-flex items-center pl-2 pr-2 pt-2 pb-2 -ml-px text-sm font-medium text-primary bg-primary border border-primary cursor-default rounded-r-md leading-5" aria-hidden="true">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                                        </svg>
                                    </span>
