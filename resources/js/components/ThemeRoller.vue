<template>
    <div>
                    ...
                    <g id="dark" transform="translate(31.401639, 48.000000)">
                        ...
                        <g id="iPhone-X" mask="url(#mask-5)">
                            <g transform="translate(15.598361, 14.000000)">
                                <rect id="Rectangle" :fill="colors.backgroundColor" fill-rule="evenodd" x="0" y="0" width="376" height="812"></rect>

                                <!-- Eyedropper backgroundColor -->
                                <g class="eyedropper" @click="selectColorFor('backgroundColor')" transform="translate(200, 400)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <g id="Forum-Cell" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(1.000000, 137.000000)">
                                    ...
                                    <text id="Commodi-a-quisquam-v" font-family="ArialMT, Arial" font-size="15" font-weight="normal" letter-spacing="0.323000014" :fill="colors.forumsTitleTextColor">
                                        <tspan x="31" y="24">Commodi a quisquam voluptatem repellendus.</tspan>
                                    </text>

                                    <!-- Eyedropper forumsTitleTextColor -->
                                    <g class="eyedropper" @click="selectColorFor('forumsTitleTextColor')" transform="translate(340, 10)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <circle id="Oval" fill="#445CD3" cx="10" cy="10" r="10"></circle>
                                        <path d="M13.948,7.552 C13.607,7.852 13.5715,8.371 13.8715,8.714 L13.252,9.2555 L10.544,6.1565 L11.1635,5.6155 C11.463,5.9575 11.9825,5.992 12.3235,5.6925 L13.9465,4.3045 C14.1815,4.101 14.4705,4 14.759,4 C15.449,4 16,4.564 16,5.2355 C16,5.6005 15.839,5.932 15.573,6.1645 L13.948,7.552 Z M10.4765,9.5 L9.2265,9.5 L11.0075,7.9385 L10.465,7.3185 L6.7955,10.512 C6.201,11.0285 6.6115,11.4275 6.1215,12.1095 C6.055,12.2025 6.0165,12.2955 6.006,12.3845 C5.973,12.6545 6.1685,12.882 6.4145,12.9125 C6.5115,12.924 6.6195,12.905 6.7225,12.844 C7.4975,12.388 7.8115,12.9025 8.4205,12.3705 L12.0905,9.1785 L11.55,8.558 L10.4765,9.5 Z M5.9235,13.25 C5.656,14.2765 5,14.4175 5,15.092 C5,15.5935 5.417,16 5.9235,16 C6.43,16 6.8405,15.5935 6.8405,15.092 C6.8405,14.4175 6.191,14.2765 5.9235,13.25 Z" id="Shape" fill="#FFFFFF" fill-rule="nonzero"></path>
                                    </g>
                                    <!-- /Eyedropper forumsTitleTextColor -->

                                    <text id="Totam-corporis-asper" font-family="ArialMT, Arial" font-size="12" font-weight="normal" letter-spacing="0.349916697" :fill="colors.contentTextColor">
                                    ...
                                    <!-- Eyedropper contentTextColor -->
                                    <g class="eyedropper" @click="selectColorFor('contentTextColor')" transform="translate(280, 45)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <circle id="Oval" fill="#445CD3" cx="10" cy="10" r="10"></circle>
                                        <path d="M13.948,7.552 C13.607,7.852 13.5715,8.371 13.8715,8.714 L13.252,9.2555 L10.544,6.1565 L11.1635,5.6155 C11.463,5.9575 11.9825,5.992 12.3235,5.6925 L13.9465,4.3045 C14.1815,4.101 14.4705,4 14.759,4 C15.449,4 16,4.564 16,5.2355 C16,5.6005 15.839,5.932 15.573,6.1645 L13.948,7.552 Z M10.4765,9.5 L9.2265,9.5 L11.0075,7.9385 L10.465,7.3185 L6.7955,10.512 C6.201,11.0285 6.6115,11.4275 6.1215,12.1095 C6.055,12.2025 6.0165,12.2955 6.006,12.3845 C5.973,12.6545 6.1685,12.882 6.4145,12.9125 C6.5115,12.924 6.6195,12.905 6.7225,12.844 C7.4975,12.388 7.8115,12.9025 8.4205,12.3705 L12.0905,9.1785 L11.55,8.558 L10.4765,9.5 Z M5.9235,13.25 C5.656,14.2765 5,14.4175 5,15.092 C5,15.5935 5.417,16 5.9235,16 C6.43,16 6.8405,15.5935 6.8405,15.092 C6.8405,14.4175 6.191,14.2765 5.9235,13.25 Z" id="Shape" fill="#FFFFFF" fill-rule="nonzero"></path>
                                    </g>
                                    <!-- /Eyedropper contentTextColor -->

                                    <text id="" font-size="14" font-weight="normal" letter-spacing="0.266000032" :fill="colors.forumsTitleTextColor">
                                ...
                                <g id="Group" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(0.000000, 88.000000)">
                                    <g id="background">
                                        ...
                                        <use fill-opacity="0.72" :fill="colors.barTintColor" fill-rule="evenodd" xlink:href="#path-6"></use>
                                    </g>
                                    <rect id="Rectangle" :fill="colors.tintColor" x="16" y="43" width="48" height="2" rx="1"></rect>
                                    <text id="Anime" font-family="ArialMT, Arial" font-size="17" font-weight="normal" line-spacing="25" letter-spacing="0.323000014" :fill="colors.tintColor">
                                        <tspan x="16" y="23">Anime</tspan>
                                    </text>
                                    <text id="Real-Life" font-family="ArialMT, Arial" font-size="17" font-weight="normal" line-spacing="25" letter-spacing="0.323000014" :fill="colors.tintColor" fill-opacity="0.5">
                                        <tspan x="90" y="23">Real Life</tspan>
                                    </text>
                                    <text id="Memes" font-family="ArialMT, Arial" font-size="17" font-weight="normal" line-spacing="25" letter-spacing="0.323000014" :fill="colors.tintColor" fill-opacity="0.5">
                                        <tspan x="181" y="23">Memes</tspan>
                                    </text>
                                    <text id="Art-Showcase" font-family="ArialMT, Arial" font-size="17" font-weight="normal" line-spacing="25" letter-spacing="0.323000014" :fill="colors.tintColor" fill-opacity="0.5">
                                ...
                                <g id="Bars-/-Navigation-Bar-/-iPhone---Compact-/-Dark---Default" fill="none">
                                    <g id="Background">
                                        ...
                                        <use fill-opacity="0.72" :fill="colors.barTintColor" fill-rule="evenodd" xlink:href="#path-8"></use>
                                    </g>
                                    ...
                                    <text id="Title" font-size="17" font-weight="500" line-spacing="22" letter-spacing="-0.409999996" :fill="colors.barTitleTextColor">
                                        <tspan x="157.919453" y="71">Forums</tspan>
                                    </text>

                                    <!-- Eyedropper barTitleTextColor -->
                                    <g class="eyedropper" @click="selectColorFor('barTitleTextColor')" transform="translate(215, 60)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <circle id="Oval" fill="#445CD3" cx="10" cy="10" r="10"></circle>
                                        <path d="M13.948,7.552 C13.607,7.852 13.5715,8.371 13.8715,8.714 L13.252,9.2555 L10.544,6.1565 L11.1635,5.6155 C11.463,5.9575 11.9825,5.992 12.3235,5.6925 L13.9465,4.3045 C14.1815,4.101 14.4705,4 14.759,4 C15.449,4 16,4.564 16,5.2355 C16,5.6005 15.839,5.932 15.573,6.1645 L13.948,7.552 Z M10.4765,9.5 L9.2265,9.5 L11.0075,7.9385 L10.465,7.3185 L6.7955,10.512 C6.201,11.0285 6.6115,11.4275 6.1215,12.1095 C6.055,12.2025 6.0165,12.2955 6.006,12.3845 C5.973,12.6545 6.1685,12.882 6.4145,12.9125 C6.5115,12.924 6.6195,12.905 6.7225,12.844 C7.4975,12.388 7.8115,12.9025 8.4205,12.3705 L12.0905,9.1785 L11.55,8.558 L10.4765,9.5 Z M5.9235,13.25 C5.656,14.2765 5,14.4175 5,15.092 C5,15.5935 5.417,16 5.9235,16 C6.43,16 6.8405,15.5935 6.8405,15.092 C6.8405,14.4175 6.191,14.2765 5.9235,13.25 Z" id="Shape" fill="#FFFFFF" fill-rule="nonzero"></path>
                                    </g>
                                    <!-- /Eyedropper barTitleTextColor -->

                                    <!-- Eyedropper barTintColor -->
                                    <g class="eyedropper" @click="selectColorFor('barTintColor')" transform="translate(265, 60)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <circle id="Oval" fill="#445CD3" cx="10" cy="10" r="10"></circle>
                                        <path d="M13.948,7.552 C13.607,7.852 13.5715,8.371 13.8715,8.714 L13.252,9.2555 L10.544,6.1565 L11.1635,5.6155 C11.463,5.9575 11.9825,5.992 12.3235,5.6925 L13.9465,4.3045 C14.1815,4.101 14.4705,4 14.759,4 C15.449,4 16,4.564 16,5.2355 C16,5.6005 15.839,5.932 15.573,6.1645 L13.948,7.552 Z M10.4765,9.5 L9.2265,9.5 L11.0075,7.9385 L10.465,7.3185 L6.7955,10.512 C6.201,11.0285 6.6115,11.4275 6.1215,12.1095 C6.055,12.2025 6.0165,12.2955 6.006,12.3845 C5.973,12.6545 6.1685,12.882 6.4145,12.9125 C6.5115,12.924 6.6195,12.905 6.7225,12.844 C7.4975,12.388 7.8115,12.9025 8.4205,12.3705 L12.0905,9.1785 L11.55,8.558 L10.4765,9.5 Z M5.9235,13.25 C5.656,14.2765 5,14.4175 5,15.092 C5,15.5935 5.417,16 5.9235,16 C6.43,16 6.8405,15.5935 6.8405,15.092 C6.8405,14.4175 6.191,14.2765 5.9235,13.25 Z" id="Shape" fill="#FFFFFF" fill-rule="nonzero"></path>
                                    </g>
                                    <!-- /Eyedropper barTintColor -->

                                    <g id="Bars-/-Navigation-Bar-/-x-/-Left-Combinations-/-Dark---Back-Button" transform="translate(0.000000, 44.000000)" :fill="colors.tintColor">
                                ...
                                <g id="Bars-/-Tab-Bar-/-Compact-/-Dark---5-Tabs" fill="none" transform="translate(0.000000, 762.000000)">
                                    <g id="Background">
                                        ...
                                        <use fill-opacity="0.72" :fill="colors.barTintColor" fill-rule="evenodd" xlink:href="#path-10"></use>
                                    </g>
                                    ...
                                    <g id="Bars-/-Tab-Bar-/-x-/-Tab-Button-/-On-Dark---Active" transform="translate(159.800000, 0.000000)" :fill="colors.tintColor">
                                        <text id="Label" font-size="10" font-weight="400" letter-spacing="-0.2411765">
                                        ...
                                        <!-- Eyedropper tintColor -->
                                        <g class="eyedropper" @click="selectColorFor('tintColor')" transform="translate(40, 0)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <circle id="Oval" fill="#445CD3" cx="10" cy="10" r="10"></circle>
                                            <path d="M13.948,7.552 C13.607,7.852 13.5715,8.371 13.8715,8.714 L13.252,9.2555 L10.544,6.1565 L11.1635,5.6155 C11.463,5.9575 11.9825,5.992 12.3235,5.6925 L13.9465,4.3045 C14.1815,4.101 14.4705,4 14.759,4 C15.449,4 16,4.564 16,5.2355 C16,5.6005 15.839,5.932 15.573,6.1645 L13.948,7.552 Z M10.4765,9.5 L9.2265,9.5 L11.0075,7.9385 L10.465,7.3185 L6.7955,10.512 C6.201,11.0285 6.6115,11.4275 6.1215,12.1095 C6.055,12.2025 6.0165,12.2955 6.006,12.3845 C5.973,12.6545 6.1685,12.882 6.4145,12.9125 C6.5115,12.924 6.6195,12.905 6.7225,12.844 C7.4975,12.388 7.8115,12.9025 8.4205,12.3705 L12.0905,9.1785 L11.55,8.558 L10.4765,9.5 Z M5.9235,13.25 C5.656,14.2765 5,14.4175 5,15.092 C5,15.5935 5.417,16 5.9235,16 C6.43,16 6.8405,15.5935 6.8405,15.092 C6.8405,14.4175 6.191,14.2765 5.9235,13.25 Z" id="Shape" fill="#FFFFFF" fill-rule="nonzero"></path>
                                        </g>
                                        <!-- /Eyedropper tintColor -->
        ...
        <!-- Submit theme form -->
        <form method="POST" :action="submit_url" id="submit-theme-form">
            <input type="hidden" v-for="(value, propertyName) in colors" :name="propertyName" :value="value" />
        </form>
        <!-- /Submit theme form -->
    </div>
</template>
