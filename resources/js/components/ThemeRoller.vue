<template>
    <div>
        <!-- iPhone SVG  -->
        <svg id="iphoneX" width="469px" height="921px" viewBox="0 0 469 921" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <defs>
                <rect id="path-1" x="0.598360656" y="0" width="407" height="843" rx="50"></rect>
                <filter x="-34.9%" y="-10.9%" width="169.8%" height="133.7%" filterUnits="objectBoundingBox" id="filter-2">
                    ...
                    <g id="dark" transform="translate(31.401639, 48.000000)">
                        ...
                        <g id="iPhone-X" mask="url(#mask-5)">
                            <g transform="translate(15.598361, 14.000000)">
                                <rect id="Rectangle" :fill="colors.background" @click="selectColorFor('background')" fill-rule="evenodd" x="0" y="0" width="376" height="812"></rect>
                                <g id="Forum-Cell" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(1.000000, 137.000000)">
                                    ...
                                    <text id="" font-family="FontAwesome5ProRegular, Font Awesome 5 Pro" font-size="20" font-weight="normal" letter-spacing="0.583194435" fill="#FFFFFF" fill-opacity="0.64">
                                        <tspan x="339" y="89"></tspan>
                                    </text>
                                    <text id="" font-family="FontAwesome5ProRegular, Font Awesome 5 Pro" font-size="20" font-weight="normal" letter-spacing="0.583194435" fill="#FFFFFF" fill-opacity="0.64">
                                        <tspan x="307" y="89"></tspan>
                                    </text>
                                    <text id="" font-family="FontAwesome5ProRegular, Font Awesome 5 Pro" font-size="22" font-weight="normal" letter-spacing="0.641513944" fill="#FFFFFF" fill-opacity="0.64">
                                        <tspan x="272" y="90"></tspan>
                                    </text>
                                    <text id="-2.2K-·--3K-·--10" font-family="FontAwesome5ProRegular, Font Awesome 5 Pro" font-size="13" font-weight="normal" letter-spacing="0.266" fill="#FFFFFF" fill-opacity="0.5">
                                        <tspan x="15" y="84"> 2.2K </tspan>
                                        <tspan x="68.3034062" y="84" font-family="LucidaGrande, Lucida Grande">·</tspan>
                                        <tspan x="72.6826875" y="84">  3K </tspan>
                                        <tspan x="121.200563" y="84" font-family="LucidaGrande, Lucida Grande">·</tspan>
                                        <tspan x="125.579844" y="84">  10hrs</tspan>
                                    </text>
                                    <text id="Commodi-a-quisquam-v" font-family="ArialMT, Arial" font-size="15" font-weight="normal" letter-spacing="0.323000014" :fill="colors.forumsTitleTextColor" @click="selectColorFor('forumsTitleTextColor')">
                                        <tspan x="31" y="24">Commodi a quisquam voluptatem repellendus.</tspan>
                                    </text>
                                    <text id="Totam-corporis-asper" font-family="ArialMT, Arial" font-size="12" font-weight="normal" letter-spacing="0.349916697" :fill="colors.contentTextColor" @click="selectColorFor('contentTextColor')">
                                    ...
                                    <text id="" font-family="FontAwesome5ProRegular, Font Awesome 5 Pro" font-size="14" font-weight="normal" letter-spacing="0.266000032" fill="#FFFFFF">
                                        <tspan x="15" y="24"></tspan>
                                    </text>
                                </g>
                                <g id="Group" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(0.000000, 88.000000)">
                                    <g id="background">
                                        <use fill="black" fill-opacity="1" filter="url(#filter-7)" xlink:href="#path-6"></use>
                                        <use fill-opacity="0.72" fill="#212121" fill-rule="evenodd" xlink:href="#path-6"></use>
                                    </g>
                                    <rect id="Rectangle" :fill="colors.tintColor" x="16" y="43" width="48" height="2" rx="1"></rect>
                                    <text id="Anime" font-family="ArialMT, Arial" font-size="17" font-weight="normal" line-spacing="25" letter-spacing="0.323000014" :fill="colors.tintColor" @click="selectColorFor('tintColor')">
                                        <tspan x="16" y="23">Anime</tspan>
                                    </text>
                                    <text id="Real-Life" font-family="ArialMT, Arial" font-size="17" font-weight="normal" line-spacing="25" letter-spacing="0.323000014" :fill="colors.tintColor" @click="selectColorFor('tintColor')" fill-opacity="0.5">
                                        <tspan x="90" y="23">Real Life</tspan>
                                    </text>
                                    <text id="Memes" font-family="ArialMT, Arial" font-size="17" font-weight="normal" line-spacing="25" letter-spacing="0.323000014" :fill="colors.tintColor" @click="selectColorFor('tintColor')" fill-opacity="0.5">
                                        <tspan x="181" y="23">Memes</tspan>
                                    </text>
                                    <text id="Art-Showcase" font-family="ArialMT, Arial" font-size="17" font-weight="normal" line-spacing="25" letter-spacing="0.323000014" :fill="colors.tintColor" @click="selectColorFor('tintColor')" fill-opacity="0.5">
                                ...
                                <g id="Bars-/-Navigation-Bar-/-iPhone---Compact-/-Dark---Default" fill="none">
                                    <g id="Background">
                                        ...
                                        <use fill-opacity="0.72" fill="#212121" fill-rule="evenodd" xlink:href="#path-8"></use>
                                    </g>
                                    <g id="Bars-/-Navigation-Bar-/-x-/-Right-Combinations-/-Dark---Bar-Button-Item" transform="translate(206.549333, 44.000000)" :fill="colors.tintColor" fill-rule="evenodd">
                                    ...
                                    <text id="Title" font-size="17" font-weight="500" line-spacing="22" letter-spacing="-0.409999996" :fill="colors.barTitleTextColor" @click="selectColorFor('barTitleTextColor')">
                                        <tspan x="157.919453" y="71">Forums</tspan>
                                    </text>
                                    <g id="Bars-/-Navigation-Bar-/-x-/-Left-Combinations-/-Dark---Back-Button" transform="translate(0.000000, 44.000000)" :fill="colors.tintColor" @click="selectColorFor('tintColor')">
                                ...
                                <g id="Bars-/-Tab-Bar-/-Compact-/-Dark---5-Tabs" fill="none" transform="translate(0.000000, 762.000000)">
                                    <g id="Background">
                                        ...
                                        <use fill-opacity="0.72" fill="#212121" fill-rule="evenodd" xlink:href="#path-10"></use>
                                    </g>
                                    <g id="Bars-/-Tab-Bar-/-x-/-Tab-Button-/-Inactive" transform="translate(310.200000, 0.000000)" fill="#8E8E93">
                                        <text id="Label" font-family="SFProText-Medium, SF Pro Text" font-size="10" font-weight="400" letter-spacing="-0.2411765">
                                    ...
                                    <g id="Bars-/-Tab-Bar-/-x-/-Tab-Button-/-On-Dark---Active" transform="translate(159.800000, 0.000000)" :fill="colors.barTintColor" @click="selectColorFor('barTintColor')">
                                        <text id="Label" font-family="SFProText-Medium, SF Pro Text" font-size="10" font-weight="400" letter-spacing="-0.2411765">
        ...
        <button @click="selectColorFor('button')" class="button is-large" :style="{backgroundColor: colors.button}">Select col</button>
