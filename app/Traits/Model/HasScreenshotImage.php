...
trait HasScreenshotImage
{
     ...
     */
    function updateScreenshotImage(string|UploadedFile $uploadFile, string $name, array $customProperties)
    {
        ...
        // Add media
        $media = $addMedia->toMediaCollection($this->screenshotImageCollectionName);
