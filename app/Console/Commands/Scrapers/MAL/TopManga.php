...
use App\Spiders\MAL\TopMangaSpider;
use Exception;
use Illuminate\Console\Command;
use RoachPHP\Roach;
use RoachPHP\Spider\Configuration\Overrides;

class TopManga extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scrape:mal_top_manga 
     ...
     * @var string
     */
    protected $description = 'Scrape top manga data from MAL.';
    ...
    public function handle(): int
    {
        ...
        foreach (range($startPage, $pages) as $page) {
            ...
            $urls[] = config('scraper.domains.mal.top_manga') . $show;
        }

        Roach::startSpider(TopMangaSpider::class, new Overrides(startUrls: $urls), ['force' => $force]);
