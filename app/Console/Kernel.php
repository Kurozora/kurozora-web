...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->call(function() {
            ...
            // Find an Anime where the actors have not been fetched
            $foundItem = Anime::where('fetched_actors', '=', false)->limit(1)->first();

            if($foundItem)
                Artisan::call('animes:fetch_actors', ['id' => $foundItem->id]);
        })->cron('*/10 * * * *');
