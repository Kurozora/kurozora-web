    ...
    public function toArray(Request $request): array
    {
        ...
        $resource = array_merge($resource, [
            ...
            'attributes'        => [
                ...
                'profile'           => ImageResource::make($this->resource->media->firstWhere('collection', '=', MediaCollection::Profile)),
                'banner'            => ImageResource::make($this->resource->media->firstWhere('collection', '=', MediaCollection::Banner)),
