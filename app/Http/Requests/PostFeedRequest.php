...
class PostFeedRequest extends FormRequest
{
    ...
    {
        return [
            'content' => ['bail', 'required_without_all:body,is_reshare', 'nullable', 'string', 'max:' . FeedMessage::maxContentLength()],
            'body' => ['bail', 'required_without_all:content,is_reshare', 'nullable', 'string', 'max:' . FeedMessage::maxContentLength()],
