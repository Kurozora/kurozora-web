...
class UpcomingAnimeSpider extends BasicSpider
{
    /**
    ...
    public array $startUrls = [
        'https://myanimelist.net/anime.php?o=9',
//        'https://myanimelist.net/anime.php?o=9&show=50',
    ];
    ...
    public function parse(Response $response): Generator
    {
        $ids = $response->filter('table[width="100%"][cellspacing="0"]')
            ...
            ->each(function (Crawler $item) {
                $sarea = $item->filter('td div.title div[id^="sarea"]');
