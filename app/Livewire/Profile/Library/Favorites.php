...
class Favorites extends Component
{
    ...
    /**
     * The user whose favorites are being viewed.
     *
     * @var User $user
     */
    public User $user;
    ...
    /**
     * Redirects the user to a random favorited item.
     *
     * @return void
     */
    ...
    {
        return $this->user->whereFavorited($modelClass)->withoutIgnoreList();
    }

    /**
     * Returns the foreign-key column on the favorites pivot table.
     *
     * @return string
     */
    ...
    {
        return match ($this->kind) {
            UserLibraryKind::Anime => __(':x’s Favorite Anime', ['x' => $this->user->username]),
            UserLibraryKind::Manga => __(':x’s Favorite Manga', ['x' => $this->user->username]),
            UserLibraryKind::Game  => __(':x’s Favorite Game', ['x' => $this->user->username]),
        };
    }
    ...
    {
        return match ($this->kind) {
            UserLibraryKind::Anime => __('No Favorite Anime'),
            UserLibraryKind::Manga => __('No Favorite Mangas'),
            UserLibraryKind::Game  => __('No Favorite Games'),
        };
    }
    ...
    {
        return match ($this->kind) {
            UserLibraryKind::Anime => __('Favorite an anime and it will show up here.'),
            UserLibraryKind::Manga => __('Favorite a manga and it will show up here.'),
            UserLibraryKind::Game  => __('Favorite a game and it will show up here.'),
        };
    }

    /**
     * Renders the unified favorites view.
     *
     * @return Application|Factory|View
     */
    public function render(): Application|Factory|View
    {
        return view('livewire.profile.library.favorites');
    }
}
