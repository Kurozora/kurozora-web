...
//        'weight_string',
    ...
    {
        // Find location of cached data
        $cacheKey = self::cacheKey(['name' => 'character.anime', 'id' => $this->id, 'tvRating' => self::getTvRatingSettings(), 'limit' => $limit, 'page' => $page]);
    ...
    /**
     * Retrieves the games for a character item in an array.
     *
     * @param int $limit
     * @param int $page
     * @return mixed
