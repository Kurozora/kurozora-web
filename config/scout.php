    ...
    'meilisearch' => [
        ...
        'index-settings' => [
            \App\Models\Anime::TABLE_NAME => [
                ...
                'filterableAttributes'=> ['id', 'letter', 'country_of_origin', 'tv_rating_id', 'media_type_id', 'source_id', 'status_id', 'genres.id', 'themes.id', 'duration', 'air_time', 'air_day', 'air_season', 'is_nsfw', 'episode_count', 'season_count', 'started_at', 'ended_at'],
            ],
            ...
            \App\Models\Game::TABLE_NAME => [
                ...
                'filterableAttributes'=> ['id', 'letter', 'duration', 'country_of_origin', 'tv_rating_id', 'media_type_id', 'source_id', 'status_id', 'genres.id', 'themes.id', 'publication_day', 'publication_season', 'is_nsfw', 'edition_count', 'published_at'],
            ],
            \App\Models\Manga::TABLE_NAME => [
                ...
                'filterableAttributes'=> ['id', 'letter', 'duration', 'publication_time', 'publication_day', 'publication_season', 'is_nsfw', 'country_of_origin', 'tv_rating_id', 'media_type_id', 'source_id', 'status_id', 'genres.id', 'themes.id', 'volume_count', 'chapter_count', 'page_count', 'started_at', 'ended_at'],
            ],
            ...
            \App\Models\User::TABLE_NAME => [
                ...
                'filterableAttributes'=> ['id', 'letter', 'is_pro', 'is_staff', 'is_developer', 'is_early_supporter', 'is_subscribed', 'subscribed_at', 'created_at'],
            ],
        ],
    ],
